module.exports = {
  ...
  networks: {
    ...
    bsc: {
      providers: [{ http: "https://bsc-dataseed1.defibit.io/" }],
      accounts: [{ file: "~/.ethereum/bsc" }],
      web3: {
        gas: [{ env: "GAS" }, { default: "6000000" }],
        gas_price: [{ env: "GAS_PRICE" }, { default: "12000000000" }],
        options: {
    ...
    fantom: {
      providers: [{ http: "https://rpcapi.fantom.network" }],
      web3: {
        gas: [{ env: "GAS" }, { default: "6000000" }],
        gas_price: [{ env: "GAS_PRICE" }, { default: "22000000000" }],
        options: {
          transactionConfirmationBlocks: 1,
          transactionBlockTimeout: 5,
        },
      },
      accounts: [{ env: "ACCOUNT" }, { file: "~/.ethereum/fantom" }],
    },
  },
