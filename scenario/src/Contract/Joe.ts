...
export interface JoeScenarioMethods extends JoeMethods {
  transferScenario(
    destinations: string[],
    amount: encodedNumber
  ): Sendable<boolean>;
...
export interface Joe extends Contract {
  methods: JoeMethods;
  name: string;
}

export interface JoeScenario extends Contract {
  methods: JoeScenarioMethods;
  name: string;
}
